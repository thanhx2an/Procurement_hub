/* checksum : 490d979facd51c96ab2580fddeb53a39 */
@cds.external : true
...
service API_PRODUCT {
  ...
  entity A_Product {
    ...
    to_Plant : Association to many A_ProductPlant {  };
    to_ProductBasicText : Association to many A_ProductBasicText {  };
    to_ProductInspectionText : Association to many A_ProductInspectionText {  };
    to_ProductProcurement : Association to A_ProductProcurement {  };
    to_ProductPurchaseText : Association to many A_ProductPurchaseText {  };
    to_ProductQualityMgmt : Association to A_ProductQualityMgmt {  };
    to_ProductSales : Association to A_ProductSales {  };
    to_ProductSalesTax : Association to many A_ProductSalesTax {  };
    to_ProductStorage : Association to A_ProductStorage {  };
    to_ProductUnitsOfMeasure : Association to many A_ProductUnitsOfMeasure {  };
    to_SalesDelivery : Association to many A_ProductSalesDelivery {  };
    to_Valuation : Association to many A_ProductValuation {  };
  };
  ...
  entity A_ProductInspectionText {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Material'
    @sap.quickinfo : 'Material Number'
    key Product : String(40) not null;
  ...
  entity A_ProductPlant {
    ...
    to_PlantMRPArea : Association to many A_ProductPlantMRPArea {  };
    to_PlantQualityMgmt : Association to A_ProductPlantQualityMgmt {  };
    to_PlantSales : Association to A_ProductPlantSales {  };
    to_PlantStorage : Association to A_ProductPlantStorage {  };
    to_PlantText : Association to A_ProductPlantText {  };
    to_ProdPlantInternationalTrade : Association to A_ProductPlantIntlTrd {  };
    to_ProductPlantCosting : Association to A_ProductPlantCosting {  };
    to_ProductPlantForecast : Association to A_ProductPlantForecasting {  };
    to_ProductPlantProcurement : Association to A_ProductPlantProcurement {  };
    to_ProductSupplyPlanning : Association to A_ProductSupplyPlanning {  };
    to_ProductWorkScheduling : Association to A_ProductWorkScheduling {  };
    to_StorageLocation : Association to many A_ProductStorageLocation {  };
  };
  ...
  entity A_ProductPlantProcurement {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Product'
    key Product : String(40) not null;
    @sap.display.format : 'UpperCase'
  ...
  entity A_ProductPlantQualityMgmt {
    ...
    @sap.quickinfo : 'Target QM System for Supplier'
  ...
  entity A_ProductSales {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Material'
    @sap.quickinfo : 'Material Number'
    key Product : String(40) not null;
    @sap.display.format : 'UpperCase'
    @sap.label : 'X-DChain Status'
  ...
  entity A_ProductSalesDelivery {
    ...
    BaseUnit : String(3);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Material Stats Group'
    ...
    to_SalesTax : Association to many A_ProductSalesTax {  };
    to_SalesText : Association to many A_ProductSalesText {  };
  };
  ...
  entity A_ProductUnitsOfMeasure {
    ...
    @sap.semantics : 'unit-of-measure'
    BaseUnit : String(3);
    to_InternationalArticleNumber : Association to many A_ProductUnitsOfMeasureEAN {  };
  };
  ...
  @sap.content.version : '1'
  @sap.label : 'GTIN Data'
  entity A_ProductUnitsOfMeasureEAN {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Material'
    @sap.quickinfo : 'Material Number'
    key Product : String(40) not null;
  ...
  entity A_ProductValuation {
    ...
    @sap.semantics : 'unit-of-measure'
    BaseUnit : String(3);
    to_MLAccount : Association to many A_ProductMLAccount {  };
    to_MLPrices : Association to many A_ProductMLPrices {  };
    to_ValuationAccount : Association to A_ProductValuationAccount {  };
    to_ValuationCosting : Association to A_ProductValuationCosting {  };
  };
  ...
  entity A_ProductValuationCosting {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Product'
    key Product : String(40) not null;
    @sap.display.format : 'UpperCase'
